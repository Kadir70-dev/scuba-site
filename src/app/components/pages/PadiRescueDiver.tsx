    ...
    <section className="relative min-h-screen w-full overflow-hidden font-habara">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center min-h-screen px-6">
        ...
        <p className="text-xs tracking-[3px] text-white/60 mb-4">
          EMERGENCY SKILLS | BECOME A CONFIDENT DIVER
        </p>

        {/* MAIN HEADING */}
        <h1 className="text-4xl md:text-6xl font-bold leading-tight max-w-4xl">
          MASTER{" "}
          <span className="text-cyan-400">RESCUE TECHNIQUES</span>
        </h1>

        {/* DESCRIPTION */}
        <p className="mt-4 text-white/70 max-w-2xl">
          Learn how to prevent and manage dive emergencies. Build confidence,
          awareness, and become a safer and more responsible diver.
        </p>
        ...
        <div className="mt-8 bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl px-8 py-6 shadow-xl">
          ...
          <p className="text-4xl font-bold">
            2,799 <span className="text-cyan-400 text-lg">AED</span>
          </p>

          <p className="text-xs text-white/60 mt-2">
            Includes Rescue Training + Certification
          </p>
        </div>
        ...
        <div className="mt-12 flex gap-10 text-white/60 text-xs flex-wrap justify-center">
          ...
          <span>✔ Diver Safety Awareness</span>
          <span>✔ Real Scenario Training</span>
        </div>
      </div>
    </section>
  );
