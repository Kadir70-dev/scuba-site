...
export function HeroSection() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden font-habara">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center min-h-screen px-6">
        ...
        >
          ...
          <p className="text-xs text-white/60 mt-2">
            Includes Full Certification + Training
          </p>
        </motion.div>
        ...
        >
          <button className="px-8 py-3 bg-cyan-400 text-black font-semibold rounded-lg hover:scale-105 transition">
            ENROLL NOW →
          </button>
        ...
        <motion.div
          ...
          className="mt-12 flex gap-8 text-white/60 text-xs flex-wrap justify-center"
        >
      ...
      {/* SCROLL INDICATOR */}
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-white/40 text-sm animate-bounce">
        ↓ Scroll
      </div>
