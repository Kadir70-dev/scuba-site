...
export function AbdullahProfileModal({
  open,
  onClose,
}: Props) {
  return (
              ...
              <div className="relative flex flex-col justify-center p-10 md:p-16">
                ...
                >
                  ...
                  <p>
                    ...
                    Abdullah ensures DiveCampus
                    logistics and operations run
                    smoothly every day.
                  </p>

                  <p>
                    From deliveries to transporting
                    guests safely to dive sites,
                    he handles every detail with
                    reliability and care.
                  </p>

                  <p>
                    His positive attitude and
                    helpful personality make him
                    an essential part of the
                    DiveCampus experience.
                  </p>
